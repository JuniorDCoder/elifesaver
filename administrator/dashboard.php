        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">ElifeSaver</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Blood Request</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="add-appeals.php" class="menu-link">
                    <div data-i18n="Without menu">all appeals</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="blood-appeal.php" class="menu-link">
                    <div data-i18n="Without navbar">Create a blood appeal</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Donors</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="add-donor.php" class="menu-link">
                    <div data-i18n="Account">Add donor</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="donor-list.php" class="menu-link">
                    <div data-i18n="Notifications">Donor list</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Patients</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="new-patient.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">New Patient</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="patient-list.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">patient list</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Doctors</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="add-doctor.php" class="menu-link">
                    <div data-i18n="Error">add doctor</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="doctor-list.php" class="menu-link">
                    <div data-i18n="Under Maintenance">doctor List</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">Groups</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="all-groups.php" class="menu-link">
                    <div data-i18n="Accordion">all groups</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="new-group.php" class="menu-link">
                    <div data-i18n="Alerts">new group</div>
                  </a>
                </li>
               <!--  <li class="menu-item">
            ...
            <!-- health facility Extended components -->
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-copy"></i>
                <div data-i18n="Extended UI">Health Facilities</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="facilities.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Facilities</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="add-facility.php" class="menu-link">
                    <div data-i18n="Text Divider">Add Facility</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Forms & Tables -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Blood Bank &amp; QC</span></li>
            <!-- Forms -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">Blood Bank</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="forms-basic-inputs.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Available blood</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="forms-input-groups.php" class="menu-link">
                    <div data-i18n="Input groups">Add Blood</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
               <!-- --><a href="temperature.php" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail">Temperature</i> 
                   
              </a>
               <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form-layouts-vertical.php" class="menu-link">
                    <div data-i18n="Vertical Form">Blood Production</div>
                  </a>
                </li>
               <!-- <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="inventory.php" class="menu-link">
                ...
                <div data-i18n="Tables">Inventory Management</div>
              </a>
            </li>
            <!-- Misc -->
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Bamenda Regional Hospital! 🎉</h5>
                          <p class="mb-4">
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Total Request</h5>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="text-center fw-semibold pt-3 mb-2">62% Blood Appeal</div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Blood Bags</span>
                          <h3 class="card-title text-nowrap mb-2">300</h3>
                          <small class="text-danger fw-semibold"><i class="bx bx-down-arrow-alt"></i> more</small>
                        </div>
                      </div>
                    </div>
                    <div class="col-6 mb-4">
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title">
                                <h5 class="text-nowrap mb-2">Successful request</h5>
                                <span class="badge bg-label-warning rounded-pill">Year 2023</span>
                              </div>
                              <div class="mt-sm-auto">
                                <small class="text-success text-nowrap fw-semibold"
                                  ><i class="bx bx-chevron-up"></i> more</small
                                >
                                <h3 class="mb-0">10</h3>
                              </div>
                            </div>
                      ...
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          ...
                          <div class="d-flex justify-content-center pt-4 gap-2">
                            ...
                            <div>
                              <p class="mb-n1 mt-1">Blood input This Week</p>
                              <small class="text-muted">2.9 more than last week</small>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-6 col-lg-4 order-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Blood bank</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
