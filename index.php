...
<nav class="navbar main-nav fixed-top navbar-expand-lg large">
  <div class="container">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link scrollTo" href="#pricing">Users</a>
        </li>
        <!--<li class="nav-item">
		...
		<li class="nav-item">
			<a class="nav-link scrollTo" href="view/login.php">Login</a>
		  </li>
      </ul>
      </div>
  </div>
		...
		<div class="row">
			<div class="col-md-8 align-self-center">
				...
				<div class="content-block">
					<h1>Your Blood donor finder</h1>
					<h5>Find a compatible blood donor anytime, anywhere with ease</h5>
					<!-- App Badge -->
					<div class="app-badge">
			...
			<div class="col-lg-6 col-md-10 m-md-auto align-self-center ml-auto">
				<div class="about-block">
					...
					<div class="about-item">
						...
						<div class="content">
							<h5>Blood Appeal</h5>
							<p>Send a blood appeal anytime anywhere to blood donors registerd in our system with just a click 
								and get a timely responds
							</p>
						</div>
					</div>
					<!-- About 02 -->
					<div class="about-item active">
						...
						<div class="content">
							<h5>TRACK LAB RESULTS</h5>
							<p>Register as a donor to easily track your laboratory results and get intitled to the added benefits of being a blood donor</p>
						</div>
					</div>
					<!-- About 03 -->
					<div class="about-item">
						...
						<div class="content">
							<h5>Be known for saving lifes</h5>
							<p>Belong to a blood donor community and enjoy the benefits that comes with donating every pine of Blood
								Get aknowlege when ever your blood is used to safe a life
							</p>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h2>App Features</h2>
					<p>The solution to ease the recruitment of blood donors durring emergencies</p>
				</div>
			</div>
		</div>
		<div class="row bg-elipse">
			<div class="col-lg-4 align-self-center text-center text-lg-right">
				...
				<div class="feature-item">
					...
					<div class="content">
						...
						<p> Send a blood appeal to donors with your required blood group around the location of your health 
							facility to get them donate blood for you or your patient</p>
					</div>
				</div>
				<!-- Feature Item -->
				<div class="feature-item">
					...
					<div class="content">
						...
						<p> Push notifications are sent to donors so that they should not miss blood appeal from patients in need of a transfusion</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 text-center">
				...
				<div class="feature-item mb-0">
					...
					<div class="content">
						...
						<p>Register to become a donor and enjoy the privilages that comes with saving lifes throug blood donation</p>
					</div>
				</div>
				...
				<div class="feature-item">
					...
					<div class="content">
						<h5>vaccines</h5>
						<p>Track and monitor your vaccines to ensure a state of good health </p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 text-center text-lg-left align-self-center">
				...
				<div class="feature-item">
					...
					<div class="content">
						<h5>lab results</h5>
						<p> Get your laboratory result instantly when it is ready at the laboratoy on your mobile device</p>
					</div>
				</div>
				<!-- Feature Item -->
				<div class="feature-item">
					...
					<div class="content">
						...
						<p>Access our application in all platforms, be it IOS or Andriod</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title mb-4">
					<h2 class="mb-3">Our User</h2>
					<p>We are a platform that engages our users into performing life saving actions through the donation of blood</p>
				</div>
			</div>
		</div>
		<div class="row">
...
<div class="pricing-table text-center">	
	...
	<ul class="feature-list">
		<li>Send Blood Apeals</li>
		<li>Get notifications</li>
		
	</ul>
	<!-- Take Action -->
	<div class="action-button">
		<a href="" class="btn btn-main-rounded">Login</a>
	</div>
</div>
			</div>
			<div class="col-lg-4 col-md-6">
...
<div class="pricing-table featured text-center">	
	...
	<!-- Features Tag -->
	<div class="price">	
		<!--<p>Blood<span>donation</span></p> -->
	</div>
	<!-- Features -->
	<ul class="feature-list">
		<li>Donate blood</li>
		<li>View Lab results</li>
		<li>Vaccine managment</li>
...
<div class="pricing-table text-center">	
	...
	<!-- features -->
	<div class="price">	
		<!--<p>Push<span>notification</span></p>--> 
	</div>
	<!-- Features -->
	<ul class="feature-list">
		<li>Feed back on transfusion</li>
		<li>Acknoledge Donors</li>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
				<div class="counter-item">
					<!-- Counter Number -->
					<h3><span class="count" data-count="29"></span></h3>
					<!-- Counter Name -->
					<p>Download</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
				<div class="counter-item">
					<!-- Counter Number -->
					<h3><span class="count" data-count="200"></span></h3>
					<!-- Counter Name -->
					<p>Active Account</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
				<div class="counter-item">
					<!-- Counter Number -->
					<h3><span class="count" data-count="60"></span></h3>
					<!-- Counter Name -->
					<p>Happy User</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
				<div class="counter-item">
					<!-- Counter Number -->
					<h3><span class="count" data-count="300"></span><sup>+</sup></h3>
					<!-- Counter Name -->
					<p>Download</p>
				</div>
			</div>
			...
			<div class="col-lg-8 align-self-center">
				<div class="content">
					...
					<div class="description">
						<p>You have question regarding ElifeSaver, please fill up the boxes below and an agent will reach out to you shortly</p>
					</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 mr-auto">
        ...
        <div class="copyright">
          <p>@2023 E life Saver All Rights Reserved |
      ...
      <div class="col-lg-6 text-lg-right">
        ...
        <ul class="social-icons list-inline">
          <li class="list-inline-item">
            <a target="_blank" href=""><i class="text-primary ti-facebook"></i></a>
          </li>
          <li class="list-inline-item">
            <a target="_blank" href=""><i class="text-primary ti-twitter-alt"></i></a>
          </li>
          <li class="list-inline-item">
            <a target="_blank" href=""><i class="text-primary ti-linkedin"></i></a>
          </li>
          <li class="list-inline-item">
            <a target="_blank" href=""><i class="text-primary ti-instagram"></i></a>
          </li>
        </ul>
        <!-- Footer Links -->
